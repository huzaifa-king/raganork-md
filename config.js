...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~db0ba3fa9f19253a6f4e98eebe7601a6:79484950667038574939343d',
    ...
    BOT_NAME: process.env.BOT_NAME || '𓆩𓏲ིྀłł𝐮፝֟͜͡͡ȥɑ͢𝖎ƒɑ͢𓆪  🅺𝖎ɳｇ♛',
    ...
    SUDO: process.env.SUDO || "923172290399",
